        ...
        <div class="container">
            ...
            <div class="box" >
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-12">
                        <button class="btn btn-outline-success" data-toggle="modal" data-target="#aaa">Apoiar esse projeto</button>
                    </div>
                </div>
            </div>
            <br />
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Apoiar [Projeto 1] em quanto?</h5>
                            ...
                            <div class="modal-body">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Digite o quanto voc&ecirc; deseja doar">
                                </div>
                            </div>
            ...
            <div style="border: lightgray solid 1px; padding: 3% 10% 3% 10%;" >
                ...
                <div class="row">
                    <div class="col-md-8"></div>
                    <div class="col-md-4 col-sm-12">
                        <button class="btn btn-outline-success">Apoiar esse projeto</button>
                    </div>
                </div>
            </div>
