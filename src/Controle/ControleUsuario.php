...
class ControleUsuario {
    ...
    public function novoAdministrador($nome, $cpf, $email, $senha) {
        throw new Exception("Metodo Não implementado ainda");
    }
    ...
    public function novoFuncionario($nome, $cpf, $email, $senha) {
        throw new Exception("Metodo Não implementado ainda");
    }
